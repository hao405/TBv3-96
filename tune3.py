...
def objective(trial):
    ...
    args.batch_size = trial.suggest_categorical('batch_size', [8,16,24,32])
    ...
    possible_n_heads = [h for h in [16,32,64] if args.d_model % h == 0]
    ...
    args.alpha = trial.suggest_float('alpha', 0.15, 0.30, log=True)
